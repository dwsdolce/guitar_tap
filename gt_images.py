...
class GtImages:
    ...
    def create_images():
        ...
        GtImages._red_pixmap = QtGui.QPixmap(
            os.path.join(basedir, "./icons/led_red.png")
        )
        GtImages._red_icon = QtGui.QIcon(GtImages._red_pixmap)
        red_button_pixmap = QtGui.QPixmap(
            os.path.join(basedir, "./icons/red_button.png")
        )
        GtImages._red_button_icon = QtGui.QIcon(red_button_pixmap)
        GtImages._green_pixmap = QtGui.QPixmap(
            os.path.join(basedir, "./icons/led_green.png")
        )
        GtImages._green_icon = QtGui.QIcon(GtImages._green_pixmap)
        green_button_pixmap = QtGui.QPixmap(
            os.path.join(basedir, "./icons/green_button.png")
        )
