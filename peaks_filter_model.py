    ...
    def lessThan(self, left: QtCore.QModelIndex, right: QtCore.QModelIndex):
        ...
        match left.column():
            ...
            case ColumnIndex.Freq.value | ColumnIndex.Mag.value:
                ...
                less_than = self.sourceModel().data_value(
                    left
            ...
            case ColumnIndex.Cents.value:
                ...
                left_cents = self.sourceModel().pitch.cents(
                    self.sourceModel().freq_value(left)
                )
                right_cents = self.sourceModel().pitch.cents(
                    self.sourceModel().freq_value(right)
                )
