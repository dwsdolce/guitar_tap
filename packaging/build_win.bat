...
REM ===============================================
REM Refuse to build a tree with a stale release identity: a version number that
REM still names an already-shipped release, or release notes never rolled over
REM after it. ONE implementation of the rule, shared with the app's startup
REM check and the sh build scripts - nothing to keep in sync here.
REM ===============================================
